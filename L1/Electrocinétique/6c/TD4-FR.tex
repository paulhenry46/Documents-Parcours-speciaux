...
\warningInfo{Dérivées de grandeurs complexes}{On peut montrer que dériver par rapport au temps c'est multiplier par \(j\omega\), intégrer c'est diviser par cette quantité.}
