...
1 \r{A}\marginCritical{Un atome a un ordre de grandeur de 100pm = 1 \r{A}}  = $1\times 10^{-10}$m = 100 pm
\subsection{Énergie}
...
\warningInfo{Masse d'un élément (mélange d'isotopes)}{La masse atomique d'un élément constitué de plusieurs Isotopes vaut la moyenne des masses des différents isotopes stables pondérée par leur abondance naturelle.}
