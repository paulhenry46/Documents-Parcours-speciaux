...
\begin{itemize}
 ...
 \item Il existe une résonance si $ 1-\frac{1}{2Q^2} >0 \iff Q > \frac{1}{\sqrt{2}}$.\marginInfo{ L'oscillateur est obligatoire en régime pseudo-périodique. Les condition de résonance sont uniquement sur $Q$ mais nécessite quand m\^eme un forçage.}
 \begin{itemize}
